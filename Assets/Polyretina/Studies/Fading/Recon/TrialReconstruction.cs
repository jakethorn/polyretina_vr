...
namespace LNE.Studies.FadingV2
{
	public class TrialReconstruction : MonoBehaviour
	{
		...
		[SerializeField]
		private int _trialsPerCondition = 5;
		...
		void Awake()
		{
			...
			_strategies = new Strategy[_trialsPerCondition * strategyCombos.Length];

			for (int i = 0; i < _trialsPerCondition; i++)
			{
